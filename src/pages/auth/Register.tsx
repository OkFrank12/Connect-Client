...
const Register = () => {
  ...
  return (
    <div className="flex w-[100%] medium:flex-col ">
      <div
        className="w-[50%] h-[100vh] flex flex-col justify-center items-center medium:w-full medium:h-[250px]  "
        style={{
      ...
      <div className="w-[50%] flex justify-center items-center h-[100vh] medium:h-[calc(100vh-250px)] medium:w-full">
        <form onSubmit={onSubmit} className="flex flex-col justify-center">
          ...
          <div className="flex flex-col items-center mb-8">
            <img
              className="w-[100px] h-[100px] rounded-[50%] object-cover border-4 border-[#410441]  "
              src={avatar}
            />
            <label
              className="py-2 px-4 my-2 bg-purple-700 text-purple-200 rounded-md hover:scale-[1.02] hover:cursor-pointer duration-300 transition-all "
              htmlFor="image"
            >
              upload image
            </label>
